...
<div id="topbar" role="banner">
   ...
   <a href="<?php echo htmlspecialchars($_SERVER['REQUEST_URI'], ENT_QUOTES); ?>#menu<?php echo $purifier->purify($_REQUEST['_cid'])  ?>"  accesskey="m"><img src="<?php echo $this->base_path; ?>images/clr.gif" height="1" width="1" alt="<?php echo _AT('goto_menu'); ?> ALT+m" /></a>
   <?php global $_config;
...
<div class="tool_switch">
 <label class="switch" for="tool_slider">
  ...
  <div class="slider round toggle_tools_on"  id="toggle_tools" title="<?php echo _AT('toggle_toolbar'); ?>" tabindex="0"></div>
  </label>
</div>

  <div class="shortcuts" style="float:right;">
  <span style="font-size:0px;" aria-live="polite" aria-label="<?php echo _AT('toolbar_on'); ?>"></span>
    <ul>
  ...
  <?php if (isset($this->course_id) && $this->course_id > 0) {?>
      ...
      <li><a href="<?php echo $this->base_path; ?>file_manager/index.php?_course_id=<?php echo $this->course_id; ?>">
        <img src="<?php echo $this->base_path. "themes/".$this->theme."/images/file-manager.png"; ?>" title="<?php echo _AT('file_manager'); ?>" alt="<?php echo _AT('file_manager'); ?>"  class="shortcut_icon"/>
        </a>
      </li>
