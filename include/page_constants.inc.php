...
if (array_key_exists(TR_PRIV_TEMPLATE_EDITOR, $privs) && Utility::authenticate($privs[TR_PRIV_TEMPLATE_EDITOR], false))
{
	...
	$_pages['template_editor/index.php']['guide']     = 'TR_HELP_TEMPLATE_EDITOR';
	...
	$_pages['template_editor/edit_layout.php']['guide']     = 'TR_HELP_LAYOUT_EDITOR';
	...
	$_pages['template_editor/edit_structure.php']['guide']     = 'TR_HELP_STRUCTURE_EDITOR';
	...
	$_pages['template_editor/edit_page.php']['guide']     = 'TR_HELP_PAGE_TEMPLATE_EDITOR';
