...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_HELP_TEMPLATE_EDITOR','<h2>Template Editor</h2><p>The Template Editor allows administrators to create, edit and manage AContent templates. The Template Editor has four tabs, the first tab is for creating new templates. The other three show existing theme, structure, and page templates, that you can edit by clicking on them.</p><h3>Creating a New Template</h3><p>To create a new template you provide the template details, also known as metadata. Template Name, Template Type, Maintainer Name, Release Version and Release State fields are required. Most fields are self-explanatory. You can choose three template types: Theme, Structure and Page Template. By clicking the Create button the new template is created and opened in the respective template editor.</p>','2016-01-25 18:43:36','');
