...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_CONFIRM_DELETE_MYOWN_PATCH','Are you sure you want to <strong>delete</strong> update <strong>%s</strong>','2018-01-24 19:19:29','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_CONFIRM_DELETE_TEST','Are you sure you want to delete the test/survey <strong><em>%s</em></strong>? The questions will not be deleted.','2018-01-24 19:20:55','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_CONFIRM_NO_ANSWER','You are about to add a question with no correct choice. Continue?','2013-01-04 14:07:58','Create questions');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_ERROR_DIRECTORY_NOT_WRITABLE','The templates/ directory is not writable. Make it recursively writable (chmod -R 777 templates) while creating or modifying templates, then change back to read only (chmod -R 644 templates) when you are done.','2017-02-16 16:43:38','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_ERROR_FILE_TOO_BIG','The file size exceeds the limit of <strong>%s </strong>. Contact your AContent Administrator to have this limit increased.','2018-01-24 19:28:28','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_ERROR_IMPORTDIR_IMS_NOTVALID','Import failed. Is not a ZIP file.','2011-10-28 16:08:54','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_ERROR_IMS_AUTHORIZATION_NOT_SUPPORT','Common Cartridge authentication not supported. This cartridge cannot be imported.','2012-12-13 12:57:41','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_ERROR_LOGIN_REQUIRED','Unable view the page. Please login first.','2012-10-09 15:12:20','Trying to access pages without being logged in');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_ERROR_SAVE_BEFORE_PROCEED','Please save the content before proceeding.','2012-12-05 11:09:50','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_ERROR_UPLOAD_FAILED','File upload failed. Maximum ile size is 200kb, and must be a png, jpg, or gif image.','2017-02-16 17:32:45','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_FEEDBACK_META_UPDATED','Template metadata was saved.','2018-01-18 17:41:14','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_FEEDBACK_TEMPLATE_DIR_WRITABLE','The templates/ directory is currently writable, needed when creating and editing templates. Set the templates/ directory to read only for added security, when template editing is complete.','2017-03-22 18:12:43','template editor');
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_FEEDBACK_TEMPLATE_UPDATED','Template successfully updated','2016-06-30 20:30:45','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_HELP_CREATE_UPDATE','<h2>Creating Update</h2>\r\n\r\n<p>If you happen to come across a bug you can fix, or have a new feature you would like added to AContent, you can use Create Update to put your changes into a form that can be easily added to the AContent public code. Or, if you have a feature you are adding to one AContent installation that you would like to have added to another, Create Update is ideal for reproducing your feature across installations. If you are creating new features or customizations that are not going to become part of the AContent public source code, you can build them into an update so they can be reapplied from version to version as you upgrade your AContent system. Creating updates does require knowledge of PHP, and of SQL if you plan on creating an update that changes the AContent database. Please refer to the appropriate documentation for information on PHP and SQL. <p>\r\n\r\n<dl>\r\n	<dt>AContent Update ID</dt>\r\n	<dd>The update id you give to your update must be different from all updates available for the particular version of AContent it applies to. It is suggested you prefix your updates with a special identifier that represents the author or the authoring organization. If for example the University of Toronto is creating the update, a update ID might look like \"uoft_0002.\"</dd>\r\n	<dt>AContent Version to Apply</dt>\r\n	<dd>This needs to be the exact version number of the AContent version the update applies to (e.g 1.6). including any minor version numbers (e.g 1.6.1.2)  The exact version number can be found on the Administrator open screen under \"Statistics and Information.\" In most cases when applying an update created for an older version of AContent, the \"AContent version to Apply\" will need to be adjusted. Or, this can be adjusted manually in the patch.xml file included with the source code of the update.\r\n	</dd>\r\n	<dt>Description</dt>\r\n	<dd>This should be a detailed description of what the update does. Example might include \"fixes problem uploading files to filemanager\" for a bug fix, or \"added a timer function to tests\" for an added feature, or \"removes registration tab\" for a feature adjustment, etc. Include enough detail so those applying the update understand exactly what it will do.</dd>\r\n	<dt>SQL Statement</dt>\r\n	<dd>This optional field can be used to insert SQL commands that modify the AContent database. It might be used to write an SQL statement to modify and existing table, such as changing a data type, or a field size, or to add or remove an field. It can also be used to insert SQL that generates a new table for a new feature created by a update, or it can be used to insert data into a table used by a feature created by the update. Any SQL can be included in this field. Be careful when running SQL, that that SQL is not going to interfere with upgrade SQL. If you are changing table structures and those same tables are being altered during an upgrade, the upgrade may fail.</dd>\r\n	<dt>Dependant Updates</dt>\r\n	<dd>It is common for later updates to require changes from earlier updates before they can be installed. If this is the case for the update you are creating, enter the update IDs into the Dependant Update ID field. Click on Add Dependent Update if additional dependencies are required. </dd>\r\n	<dt>Files</dt>	\r\n	<dd>This area is where most AContent updates are created. Click on <strong>Add File</strong>  to generate an update block. A update block can include one of four actions on the file being modified, as described below. As many update blocks as are required can be added to an update. </dd>\r\n		<dl>\r\n	<dt>Add File</dt>\r\n	<dd>The <strong>Add</strong> action can be used to add a new file to AContent. This action is often used in conjuction with other update blocks that alter or delete files, to add a replacement file for one deleted, or to perhaps add a required or include file needed by a modified section in the file being changed. In the <strong>File Name</strong> field enter the file name to be assigned to the file when it is installed. In the <strong>Directory</strong> field enter the <i>relative path</i> from the AContent root directory in which the modified file is or will exist. Select  from <strong>Upload File</strong> using the Browse button to locate the file in your local computer\'s file system. Note that the upload file can have any name. It will be renamed to the file name listed in the File Name field when it is installed.</dd>\r\n	<dt>Alter File</dt>\r\n	<dd>This option is used when you wish to make changes to a piece of code within an existing source code file. In the <strong>File Name</strong> field enter the name of the file in the AContent source code that will be altered. In the <strong>Directory</strong> field enter the relative path to the directory in which the to be alter file exists, relative to the AContent root directory. In the <strong>Code To Replace From</strong> field copy the code from the original file that will be replaced, or appended to, and in the <strong>Code To Replace To</strong> field enter to code that will replace the code above in the <i>From</i> field. Or, if you are adding code instead of replacing code, include the code from the field above so it gets added back if you are only using that code as a way of identifying a location in the file where new code is being added.</dd>\r\n	<dt>Delete File</dt>\r\n	<dd>This option will remove files from AContent. In the <strong>File Name</strong>  field enter the name of the file to be deleted. In the <strong>Directory</strong> field enter the path to the directory in which the to be delete file exists, relative to the root directory of the AContent installation. </dd>\r\n	<dt>Overwrite File</dt>\r\n	<dd>This option is used to replace an existing file in AContent with a new one. In the <strong>File Name</strong>  field enter the name of the file to be replaced. In the <strong>Directory</strong> field enter the path to the directory in which the to be replaced file exists, relative to the root directory of the AContent installation. In the <strong>Upload File</strong> field use the Browse button to choose a file from your local computer to replace the specified file. The upload file may be named anything. It will be renamed to the file it is replacing when the update is installed.</dd>\r\n	</dl>\r\n	<dt>Create Update</dt>\r\n	<dd>Click on this button to build the update into a downloadable zip file. This zip file can then be uploaded in the Upload field on the main Updater screen to apply an update to a system, or it can be redistributed.</dd>\r\n	<dt>Save Update</dt>\r\n	<dd>Click on this button to save the developing update to the AContent database for future reference. Though it is not required, you should save a copy of the update in this way, so it can be retrieved and edited if necessary. Or, if an update takes more than a single sitting to build, you can save it, then retrieve it later to continue.</dd>\r\n	<dt>Cancel</dt>\r\n	<dd>Press this button to ignore the latest changes to the update, and return to My Own Updates Screen.</dd>\r\n\r\n</dl>','2018-01-24 20:00:56','Updater');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_WARNING_NO_STRUCT','No structure found.','2012-12-04 12:16:09','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','TR_WARNING_TEMPLATE_DIR_NOT_WRITABLE','The templates/ directory is currently read-only. Before creating or editing templates, change the templates/ directory, and its content, to writable.','2017-02-27 19:01:40','template editor');
...
INSERT INTO `language_text` VALUES ('en', '_template','access','Access','2013-01-29 10:08:03','');
...
INSERT INTO `language_text` VALUES ('en', '_template','add_forum','Add Forum','2013-07-13 08:55:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','add_page_template','Add Page Template','2013-07-13 08:53:00','');
INSERT INTO `language_text` VALUES ('en', '_template','add_page_templates','Add Page Templates','2013-07-13 08:53:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','add_top_structure','Add Top Structure','2012-12-06 12:37:30','');
INSERT INTO `language_text` VALUES ('en', '_template','add_to_test_survey','Add to Test/Survey','2010-03-23 11:04:47','');
INSERT INTO `language_text` VALUES ('en', '_template','advanced','Advanced','2013-08-19 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','after_topic','After: %s','2010-06-01 10:04:43','');
INSERT INTO `language_text` VALUES ('en', '_template','align_center','Align Center','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','align_left','Align Left','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','align_right','Align Right','2013-08-10 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','assign_author','Assign to Author','2012-11-28 14:44:46','create lesson');
INSERT INTO `language_text` VALUES ('en', '_template','associated_images ','Associated Images ','2013-08-19 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','auto_generate','Auto Generate','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','background-color','Background Color','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','background-image','Background Image','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','back_to','Back To:','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','basic','Basic','2013-08-19 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','bold','Bold','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','border-color','Border Color','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','border-style','Border Style','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','border-width','Border Width','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','border_dashed','Dashed','2016-01-25 18:03:03','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','border_dotted','Dotted','2016-01-25 18:04:36','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','border_solid','Solid','2016-01-25 18:02:30','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','box','Box','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','choice_template','Enable:','2012-12-04 12:07:59','admin system preferences');
INSERT INTO `language_text` VALUES ('en', '_template','choose_lang','Choose a language to translate','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','choose_structure','Choose the structure','2012-12-05 15:17:05','');
...
INSERT INTO `language_text` VALUES ('en', '_template','columns','Columns','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','confirm_image_delete','Are you sure you want to delete <strong>%s</strong>?','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','confirm_template_delete','Are you sure you want to delete the template <strong>%s</strong>?','2013-07-13 09:15:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','content_associated','Content associated','2012-12-07 10:42:05','templating system');
...
INSERT INTO `language_text` VALUES ('en', '_template','copy_page_template','Copy model sequence','2012-12-04 12:11:58','');
...
INSERT INTO `language_text` VALUES ('en', '_template','course_owner','Owner','2012-11-28 16:26:29','');
...
INSERT INTO `language_text` VALUES ('en', '_template','create_content_3','Create Lesson: <a href=\"%s\">select one structure</a> to create a structured lesson','2012-12-04 16:23:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','create_template','Create Template','2013-07-13 08:46:35','');
INSERT INTO `language_text` VALUES ('en', '_template','create_test','Create Test/Survey','2010-03-11 14:37:00','');
INSERT INTO `language_text` VALUES ('en', '_template','create_this_structure','Create lesson with this structure','2012-12-06 11:32:59','');
...
INSERT INTO `language_text` VALUES ('en', '_template','default_use_template','Default: Enable','2012-12-04 12:07:25','admin system preferences');
...
INSERT INTO `language_text` VALUES ('en', '_template','delete_image','Delete Image','2013-08-19 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','details','Details','2017-02-16 15:45:17','');
INSERT INTO `language_text` VALUES ('en', '_template','devoid_content','Content devoid of text, below is an example with default text.','2012-12-10 11:19:53','templating system');
...
INSERT INTO `language_text` VALUES ('en', '_template','document_body','Body of the document','2012-12-10 11:17:12','templating system');
...
INSERT INTO `language_text` VALUES ('en', '_template','edit_layout','Edit Theme','2013-07-13 08:46:35','');
INSERT INTO `language_text` VALUES ('en', '_template','edit_metadata','Edit Metadata','2013-07-13 08:49:45','');
INSERT INTO `language_text` VALUES ('en', '_template','edit_mode ','Edit Mode','2013-08-19 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','edit_page','Edit Page','2013-07-13 08:46:35','');
...
INSERT INTO `language_text` VALUES ('en', '_template','edit_structure','Edit Structure','2013-07-13 08:46:35','');
INSERT INTO `language_text` VALUES ('en', '_template','edit_template','Edit Template','2013-07-13 08:49:45','');
INSERT INTO `language_text` VALUES ('en', '_template','edit_templates','Edit Templates','2012-12-07 16:02:03','templating system');
...
INSERT INTO `language_text` VALUES ('en', '_template','empty_fields_error','One or more required fields are empty.','2013-07-13 09:09:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','enable_template','Allow the use of all templates or make a personal choice:','2012-12-04 12:02:00','admin system preferences');
...
INSERT INTO `language_text` VALUES ('en', '_template','error_no_structure','Error: the name of the structure does not correspond to a directory','2012-12-06 11:38:26','');
...
INSERT INTO `language_text` VALUES ('en', '_template','filemanager_date_format','%%Y-%%m-%%d %%H:%%i','2018-01-22 19:35:25','');
...
INSERT INTO `language_text` VALUES ('en', '_template','font_arial','Arial','2016-01-25 17:59:19','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','font_color','Font Color','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','font_courier','Courier','2016-01-25 17:57:35','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','font_family','Font Family','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','font_georgia','Georgia','2016-01-25 17:58:21','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','font_helvetica','Helvetica','2016-01-25 17:59:47','layout template eidtor');
INSERT INTO `language_text` VALUES ('en', '_template','font_size','Font Size','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','font_times_new_roman','Times New Roman','2016-01-25 17:58:53','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','font_verdana','Verdana','2016-01-25 18:00:20','layout temaplte editor');
INSERT INTO `language_text` VALUES ('en', '_template','for','for','2010-02-09 16:10:07','');
INSERT INTO `language_text` VALUES ('en', '_template','format','Format','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','forum','Forum','2013-07-13 08:59:00','');
INSERT INTO `language_text` VALUES ('en', '_template','forums','Forums','2010-06-01 13:01:09','');
INSERT INTO `language_text` VALUES ('en', '_template','forums_description','This is the description of the forum','2012-12-06 11:30:20','');
INSERT INTO `language_text` VALUES ('en', '_template','forum_associated','This content has an associated forum','2012-12-06 11:35:10','');
...
INSERT INTO `language_text` VALUES ('en', '_template','goto_content','Jump to main content','2017-02-17 14:05:52','');
INSERT INTO `language_text` VALUES ('en', '_template','goto_course','Go to \"%s\" Lesson','2013-01-29 10:12:51','');
INSERT INTO `language_text` VALUES ('en', '_template','goto_menu','Jump to side menu.','2017-02-27 19:45:34','');
...
INSERT INTO `language_text` VALUES ('en', '_template','header','Header','2013-01-03 15:53:43','');
...
INSERT INTO `language_text` VALUES ('en', '_template','hide_outline','Hide outline','2012-12-05 15:21:16','');
INSERT INTO `language_text` VALUES ('en', '_template','hide_templates','Hide Templates','2012-12-07 16:01:10','templating system');
...
INSERT INTO `language_text` VALUES ('en', '_template','icon','Icon','2012-12-06 11:50:16','');
...
INSERT INTO `language_text` VALUES ('en', '_template','image','Image','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','img_layout_icon','%s layout','2012-12-06 11:56:21','');
INSERT INTO `language_text` VALUES ('en', '_template','img_pagetemplate_icon','%s','2013-01-03 15:26:39','');
INSERT INTO `language_text` VALUES ('en', '_template','img_title_pagetemplate_icon','%s','2013-01-03 15:22:01','editor templates');
...
INSERT INTO `language_text` VALUES ('en', '_template','invalid_xml','There is a syntax error in the xml code.','2013-07-13 09:01:00','');
INSERT INTO `language_text` VALUES ('en', '_template','is_author','I would like to author content.','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','italic','Italic','2013-08-10 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','justify','Justify','2013-08-10 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','label_active_first_part','Click here to open the preview of all the page templates available','2012-12-04 12:12:50','');
INSERT INTO `language_text` VALUES ('en', '_template','label_active_second_part','or make changes to page templates already included','2012-12-04 12:13:08','');
...
INSERT INTO `language_text` VALUES ('en', '_template','layout','Themes','2013-01-18 15:47:41','');
INSERT INTO `language_text` VALUES ('en', '_template','layouts','Themes','2016-01-25 19:21:21','');
INSERT INTO `language_text` VALUES ('en', '_template','layout_associated','Theme associated to this content:  <strong>%s</strong>.','2013-01-18 15:53:58','');
INSERT INTO `language_text` VALUES ('en', '_template','layout_content_apply','Apply theme to page','2013-01-18 15:52:53','');
INSERT INTO `language_text` VALUES ('en', '_template','layout_course_apply','Apply theme to entire lesson','2013-01-18 15:53:28','');
...
INSERT INTO `language_text` VALUES ('en', '_template','link','Link','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','maintainer_email','Maintainer Email','2013-07-13 09:08:00','');
INSERT INTO `language_text` VALUES ('en', '_template','maintainer_name','Maintainer Name','2013-07-13 09:08:00','');
INSERT INTO `language_text` VALUES ('en', '_template','manage_tests','Manage Tests/Surveys','2010-03-11 14:37:00','');
INSERT INTO `language_text` VALUES ('en', '_template','mandatory_content','Mandatory Content','2012-12-05 15:05:19','');
INSERT INTO `language_text` VALUES ('en', '_template','manually','Manually','2012-12-04 16:17:58','');
...
INSERT INTO `language_text` VALUES ('en', '_template','max','Max','2013-07-13 08:52:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','min','Min','2013-07-13 08:49:45','');
INSERT INTO `language_text` VALUES ('en', '_template','missing_content','Missing Content','2010-05-19 14:04:47','');
INSERT INTO `language_text` VALUES ('en', '_template','more_course_information','more information about \"%s\" lesson','2013-01-29 10:11:03','');
...
INSERT INTO `language_text` VALUES ('en', '_template','move_down','Move Down','2013-07-13 08:57:00','');
INSERT INTO `language_text` VALUES ('en', '_template','move_up','Move Up','2013-07-13 08:57:00','');
INSERT INTO `language_text` VALUES ('en', '_template','msg_terms','Message Terms','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','must','Must','2017-02-17 14:37:05','');
...
INSERT INTO `language_text` VALUES ('en', '_template','note_at_first_access','Choose from the available templates to format the layout of this page by clicking the thumbnail images below. See the preview below the thumbnails, and press Save to add a template to this page.','2012-12-10 12:19:28','templating system');
INSERT INTO `language_text` VALUES ('en', '_template','nothing','Nothing','2012-12-06 11:51:49','');
INSERT INTO `language_text` VALUES ('en', '_template','nothing_description','Without layout','2012-12-06 11:52:07','');
INSERT INTO `language_text` VALUES ('en', '_template','not_installed','Not Installed','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','no_content_associated','<span style=\"font-weight:bold\">No content</span> associated','2012-12-07 10:41:49','templating system');
INSERT INTO `language_text` VALUES ('en', '_template','no_layout_associated','<strong>No theme</strong> associated with this content','2013-01-18 15:56:59','');
...
INSERT INTO `language_text` VALUES ('en', '_template','number_of_columns','Columns','2013-09-08 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','number_of_rows','Rows','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','ordered_list','Ordered List','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','pages','Pages','2013-07-13 08:46:35','');
INSERT INTO `language_text` VALUES ('en', '_template','page_deletable','The page can be deleted','2012-12-06 11:28:07','');
INSERT INTO `language_text` VALUES ('en', '_template','page_info','Last Modified: %s.  Revision: %s.','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','page_info_date_format','%%l %%M %%j, %%Y - %%H:%%i','2018-01-22 19:37:16','');
INSERT INTO `language_text` VALUES ('en', '_template','page_mandatory','the page is mandatory','2012-12-06 11:27:31','');
INSERT INTO `language_text` VALUES ('en', '_template','page_tempate','Page Template','2012-12-04 15:58:21','');
INSERT INTO `language_text` VALUES ('en', '_template','page_template','Template','2013-01-18 15:48:29','');
INSERT INTO `language_text` VALUES ('en', '_template','page_templates','Page Templates','2016-01-25 19:27:09','page template editor');
INSERT INTO `language_text` VALUES ('en', '_template','page_templates_tag','Page Templates','2013-07-13 08:59:00','');
INSERT INTO `language_text` VALUES ('en', '_template','page_template_tag','Page Template','2013-07-13 08:59:00','');
INSERT INTO `language_text` VALUES ('en', '_template','paragraph','Paragraph','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','paste_page_template','Paste model sequence','2012-12-04 12:12:17','');
...
INSERT INTO `language_text` VALUES ('en', '_template','personal_setting','Personal setting','2012-12-04 12:02:29','admin system preferecnes');
...
INSERT INTO `language_text` VALUES ('en', '_template','property','Property','2013-08-19 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','redo','Redo','2013-07-13 08:52:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','release_date','Release Date','2013-07-13 09:09:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','release_note','Release Note','2013-07-13 09:09:00','');
INSERT INTO `language_text` VALUES ('en', '_template','release_state','Release State','2013-07-13 09:09:00','');
INSERT INTO `language_text` VALUES ('en', '_template','release_version','Release Version','2013-07-13 09:09:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','rows','Rows','2013-09-08 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','screenshot','Screenshot','2013-08-19 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','selector','Selector','2013-08-19 09:40:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','show','Show','2017-02-16 15:44:44','');
INSERT INTO `language_text` VALUES ('en', '_template','show_outline','Show outline','2012-12-05 15:20:57','');
INSERT INTO `language_text` VALUES ('en', '_template','show_templates','Show Templates','2012-12-07 16:01:46','templating system');
INSERT INTO `language_text` VALUES ('en', '_template','side_menu','Side menu','2017-02-16 18:50:21','');
...
INSERT INTO `language_text` VALUES ('en', '_template','skip_pager','Skip over pager','2013-01-21 15:47:06','');
...
INSERT INTO `language_text` VALUES ('en', '_template','structure','Structure','2012-12-04 16:18:14','');
INSERT INTO `language_text` VALUES ('en', '_template','structures','Structures','2012-12-04 15:57:57','');
...
INSERT INTO `language_text` VALUES ('en', '_template','table','Table','2013-09-08 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','template_description','Template Description','2013-07-13 09:06:00','');
INSERT INTO `language_text` VALUES ('en', '_template','template_editor','Template Editor','2013-07-13 08:46:35','');
INSERT INTO `language_text` VALUES ('en', '_template','template_editor_howto','Editor on the left, interactive preview on the right. Accesskey e to edit, s to save, and p to go to the preview window. Navigate the preview to bring up each element\'s CSS properties.','2016-01-25 17:50:57','create template aria-label');
INSERT INTO `language_text` VALUES ('en', '_template','template_heading','Heading','2017-03-21 19:29:32','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','template_layout','Layout','2012-12-04 12:08:22','admin system preferences');
INSERT INTO `language_text` VALUES ('en', '_template','template_license','Template License','2013-07-13 09:06:00','');
INSERT INTO `language_text` VALUES ('en', '_template','template_list_item','List Item','2016-01-25 18:12:42','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','template_name','Template Name','2013-07-13 09:06:00','');
INSERT INTO `language_text` VALUES ('en', '_template','template_page','Page','2012-12-04 12:08:44','');
INSERT INTO `language_text` VALUES ('en', '_template','template_sample_text','This is some paragraph text that can be formatted to any font-family to give content a tailored look.','2016-01-25 18:11:52','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','template_structure','Structure','2012-12-04 12:09:00','');
INSERT INTO `language_text` VALUES ('en', '_template','template_table_caption','Table Caption','2016-06-29 19:34:04','');
INSERT INTO `language_text` VALUES ('en', '_template','template_table_data','data','2016-01-25 18:13:52','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','template_table_header','header','2016-01-25 18:13:25','layout template editor');
INSERT INTO `language_text` VALUES ('en', '_template','template_type','Template Type','2013-07-13 09:06:00','');
INSERT INTO `language_text` VALUES ('en', '_template','template_url','Template URL','2013-07-13 09:08:00','');
INSERT INTO `language_text` VALUES ('en', '_template','term_type','Term Type','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','test','Test','2013-07-13 08:59:00','');
INSERT INTO `language_text` VALUES ('en', '_template','testing','test','2012-12-10 16:04:53','');
INSERT INTO `language_text` VALUES ('en', '_template','tests','Tests','2010-06-10 10:17:26','');
INSERT INTO `language_text` VALUES ('en', '_template','tests_description','This is the test description','2012-12-06 11:29:59','');
INSERT INTO `language_text` VALUES ('en', '_template','test_associated','This content has an associated test.','2012-12-06 11:36:06','');
...
INSERT INTO `language_text` VALUES ('en', '_template','thumbnail','Thumbnail','2013-01-03 14:16:45','content theme panel');
INSERT INTO `language_text` VALUES ('en', '_template','title','Title','2010-01-27 15:48:35','');
INSERT INTO `language_text` VALUES ('en', '_template','title_2_columns','Title and 2 columns','2013-01-03 15:55:38','');
INSERT INTO `language_text` VALUES ('en', '_template','title_3_columns','Title and 3 columns','2013-01-03 15:56:12','');
INSERT INTO `language_text` VALUES ('en', '_template','title_FloatingImage_text','Title and Floating Image','2013-01-03 15:57:11','');
INSERT INTO `language_text` VALUES ('en', '_template','title_image','Title and Image','2013-01-03 15:59:44','');
INSERT INTO `language_text` VALUES ('en', '_template','title_image_text','Title, Image and text','2013-01-03 16:00:27','');
INSERT INTO `language_text` VALUES ('en', '_template','title_subtitle','Title and subtitle','2013-01-03 16:00:54','');
...
INSERT INTO `language_text` VALUES ('en', '_template','underline','Underline','2013-08-10 09:40:00','');
INSERT INTO `language_text` VALUES ('en', '_template','undo','Undo','2013-07-13 08:52:00','');
...
INSERT INTO `language_text` VALUES ('en', '_template','unordered_list','Title and unordered list','2013-01-03 16:03:34','');
...
INSERT INTO `language_text` VALUES ('en', '_template','value','Value','2013-08-19 09:40:00','');
