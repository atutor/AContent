...
define('AF_PRIV_HOME', 1);
define('AF_PRIV_SYSTEM', 2);
define('AF_PRIV_USER_MANAGEMENT', 3);
define('AF_PRIV_LANGUAGE_MANAGEMENT', 4);
define('AF_PRIV_TRANSLATION', 5);
define('AF_PRIV_UPDATER', 6);
define('AF_PRIV_PROFILE', 7);

/* constants used for menu item generation. Used in class Menu (include/classes/Menu.class.php) */
define('AF_NAV_PUBLIC', 'AF_NAV_PUBLIC');  // public menus, when no user login
define('AF_NAV_TOP', 'AF_NAV_TOP');        // top tab menus
...
//$_pages[AF_NAV_PUBLIC] = array('index.php' => array('parent'=>AF_NAV_PUBLIC));

/* define all accessible pages */
// 1. public pages
$_pages['register.php']['title_var'] = 'registration';
$_pages['register.php']['parent']    = AF_NAV_PUBLIC;
$_pages['register.php']['guide']    = 'AF_HELP_REGISTRATION';

$_pages['confirm.php']['title_var'] = 'confirm';
$_pages['confirm.php']['parent']    = AF_NAV_PUBLIC;

$_pages['login.php']['title_var'] = 'login';
$_pages['login.php']['parent']    = AF_NAV_PUBLIC;
$_pages['login.php']['guide']    = 'AF_HELP_LOGIN';
...
// home pages
if (in_array(AF_PRIV_HOME, $privs))
{
	$_pages['checker/index.php']['title_var'] = 'aframe';
	$_pages['checker/index.php']['parent']    = AF_NAV_PUBLIC;
	$_pages['checker/index.php']['guide']    = 'AF_HELP_INDEX';
	
	$_pages['checker/suggestion.php']['parent']    = AF_NAV_PUBLIC;
	$_pages['checker/suggestion.php']['guide']    = 'AF_HELP_SUGGESTION';
}

// system pages
if (in_array(AF_PRIV_SYSTEM, $privs))
{
	$_pages['system/index.php']['title_var'] = 'system';
	$_pages['system/index.php']['parent']    = AF_NAV_PUBLIC;
	$_pages['system/index.php']['guide']    = 'AF_HELP_SYSTEM';
}

// user pages
if (in_array(AF_PRIV_USER_MANAGEMENT, $privs))
{
	$_pages['user/index.php']['title_var'] = 'users';
	$_pages['user/index.php']['parent']    = AF_NAV_TOP;
	...
	$_pages['user/user_group.php']['guide']    = 'AF_HELP_USER_GROUP';
	...
	$_pages['user/user_group_create_edit.php']['guide']    = 'AF_HELP_CREATE_EDIT_USER_GROUP';
...
// language pages
if (in_array(AF_PRIV_LANGUAGE_MANAGEMENT, $privs))
{
	$_pages['language/index.php']['title_var'] = 'language';
	$_pages['language/index.php']['parent']    = AF_NAV_TOP;
	...
	$_pages['language/index.php']['guide']    = 'AF_HELP_LANGUAGE';
	...
	$_pages['language/language_add_edit.php']['guide']    = 'AF_HELP_ADD_EDIT_LANGUAGE';
...
// translation
if (in_array(AF_PRIV_TRANSLATION, $privs))
{
	$_pages['translation/index.php']['title_var'] = 'translation';
	$_pages['translation/index.php']['parent']    = AF_NAV_TOP;
	$_pages['translation/index.php']['guide']    = 'AF_HELP_TRANSLATION';
}

// profile pages
if (in_array(AF_PRIV_PROFILE, $privs))
{
	$_pages['profile/index.php']['title_var'] = 'profile';
	$_pages['profile/index.php']['parent']    = AF_NAV_TOP;
	$_pages['profile/index.php']['guide']    = 'AF_HELP_PROFILE';
	...
	$_pages['profile/change_password.php']['guide']    = 'AF_HELP_CHANGE_PASSWORD';
	
	$_pages['profile/change_email.php']['title_var'] = 'change_email';
	$_pages['profile/change_email.php']['parent']    = 'profile/index.php';
	$_pages['profile/change_email.php']['guide']    = 'AF_HELP_CHANGE_EMAIL';
}

// updater pages
if (in_array(AF_PRIV_UPDATER, $privs))
{
	$_pages['updater/index.php']['title_var'] = 'updater';
	$_pages['updater/index.php']['parent']    = AF_NAV_TOP;
	$_pages['updater/index.php']['guide']    = 'AF_HELP_UPDATER';
	...
	$_pages['updater/patch_create.php']['guide']    = 'AF_HELP_CREATE_UPDATE';
