...
?>
<form action="<?php echo $_SERVER['PHP_SELF'].'?'; if ($this->cid > 0) echo '_cid='.$this->cid; if ($this->pid > 0) echo 'pid='.$this->pid.SEP.'_course_id='.$this->course_id;?>" method="post" name="form"> 
