...
if ($step < 3) {
	...
	if (defined('TR_INSTALL')) {
		echo 'AContent appears to have been installed already.';
		exit;
	}
}
...
<head>
	<title>AContent Installation</title>
	<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1" />
	<link rel="stylesheet" href="stylesheet.css" type="text/css" />
</head>
<body>
<div style="height: 70px; vertical-align: bottom; background-color: #354A81">
	<h1 id="header">AContent <?php echo $new_version; ?> Installation</h1>
	<img src="../images/AC_Logo1_sm.png" height="29" width="84" alt="Logo" id="logo" />
</div>
