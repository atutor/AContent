...
if (isset($_POST['cancel'])) {
	...
	exit;
		...
		if ($testsDAO->Update($_POST['tid'], htmlspecialchars(trim(stripslashes(strip_tags($_POST['title'])))), htmlspecialchars(trim(stripslashes(strip_tags($_POST['description']))))));
	{
